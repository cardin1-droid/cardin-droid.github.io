...
<body>
    ...
    <td colspan="4" style="padding-left: 80px; padding-right:80px;">
        <p style="text-indent: 50px; text-align: justify;">This is to certify that <u><?php echo $title . ' ' . $first_name; ?> <?php echo strtoupper(substr($middle_name, 0, 1)); ?>. <?php echo $last_name; ?></u> is a bonafide resident of Barangay CANDA, Balayan, Batangas. This barangay clearance is issued upon the request of the above-named individual for whatever legal purpose it may serve.</p>
    </td>
</tr>

<tr>
    <td colspan="4" style="padding-left: 80px; padding-right:80px;">
        <p style="text-indent: 50px; text-align:justify;">This further certifies that <?php echo $title; ?> <u> <?php echo $last_name ?></u> is a person of good moral character, peace-loving, and a civic-minded citizen.</p>
    </td>
</tr>
<tr>
    <td colspan="4" style="padding-left: 80px; padding-right:80px;">
