        ...
        <div class="row bg-light rounded">
            ...
            <div class="container bg-light text-center" style="height: 430px; overflow-y: auto;padding-bottom: 15px;">
                <form id="deleteForm" action="delete.php" method="post">
                        ...
                        <table id="dataTable" class="border-0 text-center" style="width:100%; table-layout: fixed;">
                            ...
                            if ($result->num_rows > 0) {
                                while ($row = $result->fetch_assoc()) {
                                    ...
                                    echo "<td>" . ucfirst($row["birthdate"]) . "</td>";
                    ...
                    <button id="deleteSelected" class="btn btn-danger mt-2"><i class="bi bi-trash"></i> Delete Selected</button>
                    <button id="printData" class="btn btn-primary mt-2"><i class="bi bi-printer"></i> Print</button>
                </form>
            </div>
        </div>
    </div>
