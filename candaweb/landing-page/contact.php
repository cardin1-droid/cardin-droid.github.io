    ...
    <div class="contact-section">
        ...
        <div class="container mt-5 ">
            ...
            <div class="row justify-content-center">
                ...
                <div class="col-md-5 mb-4 bg-light rounded ml-2">
                    <div class="container pt-5 pb-5 justify-content-center align-items-center" style="height: 100%;">
                        <div class="row mb-5">
                            <div class="col-md-2" style="color: #202A5B; font-size: 24px;">
                                <i class="bi bi-geo-fill"></i>
                            </div>
                            <div class="col-md-10" style="color: #202A5B; font-size: 18px;">
