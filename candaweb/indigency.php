            ...
            <table class="table transparent-table">
                ...
                <tr>
                    <td colspan="4" class="text-center">
                        <h3 class="font-weight-bold">CERTIFICATE OF INDIGENCY</h3>
                    </td>
                </tr>
                <tr>
                    <td></td>
                ...
                <tr>
                    <td colspan="4" style="padding-left: 80px; padding-right:80px;">
                        <p style="text-indent: 50px; text-align:justify;">This is to certify that <?php echo $title . '<u> ' . $first_name; ?> <?php echo strtoupper(substr($middle_name, 0, 1)); ?>. <?php echo $last_name; ?></u> of legal age <u></u><?php echo ucfirst($civil_status); ?></u> is a resident of barangay CANDA, Balayan, Batangas.</p>
                    </td>
                </tr>

                <tr>
                    <td colspan="4" style="padding-left: 80px; padding-right:80px;">
                        <p style="text-indent: 50px;text-align:justify;">This further certifies that <?php echo $title; ?> <u> <?php echo $last_name ?></u> has no permanent job and belong to the listed indigent families of Barangay.</p>
                    </td>
                </tr>
                <tr>
                    <td colspan="4" style="padding-left: 80px; padding-right:80px;">
                        <p style="text-align:justify;">ISSUED this <u><?php echo $current_date; ?></u> of <u><?php echo $current_month; ?></u> <u><?php echo $current_year; ?></u> at Barangay CANDA, Balayan, Batangas to be used in any legal purpose / intent it may serve. </p>
                    </td>
                </tr>
                <tr>
                    <td></td>
